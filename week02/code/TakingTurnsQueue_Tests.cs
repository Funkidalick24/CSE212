...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the _queue variable starts at zero hence it was returning Sue instead of Bob
    ...
    // Defect(s) Found: Same issue with the takingTurnsQueue test
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: missing implementation for infinite turns in the TakingTurnsQueue class
    ...
    // Defect(s) Found: same issue as the TakingTurnsQueue_ForeverZero test
